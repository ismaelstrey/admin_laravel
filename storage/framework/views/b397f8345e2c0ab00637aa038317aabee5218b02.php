...
<div class="banner" id="templatemo_banner_slide">
    <ul>
    <?php if(isset($dados['banner'])): ?>       
   
        <?php foreach($dados['banner'] as $banner): ?> 
            <li class="templatemo_banner_slide_0<?php echo e($banner->id++); ?>">
...
<?php $__env->startSection('sobre'); ?>
    <div id="templatemo_about" class="container_wapper">
    <div class="container-fluid">
<h1>Nossos serviços</h1>
<?php if(isset($dados['servicos'])): ?>
    <?php foreach($dados['servicos'] as $servico): ?>        
            <div class="col-sm-6 col-md-3 about_icon">
                <div class="imgwap mission"><i class="fa <?php echo e($servico->icone); ?>"></i></div>
                <h2><a href="<?php echo e(url('empresa/servicos/').'/'.$servico->id); ?>" title="<?php echo e($servico->nome); ?>"><?php echo e($servico->nome); ?></a></h2>
...
<?php $__env->stopSection(); ?>
<?php $__env->startSection('event'); ?>
    <div id="templatemo_events" class="container_wapper">
    <div class="container-fluid">
        <h1>Postagens</h1>
            <?php if(isset($dados['postagens'])): ?>
                <?php foreach($dados['postagens'] as $postagen): ?> 
                   <div class="col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-0">
                        <div class="event_box_wap event_animate_left">
                            <div class="event_box_img">
                                <img src="<?php echo e(url('images/uploads/'.$postagen->imagem)); ?>" class="img-responsive" alt="Web Design Trends" />
                            </div>
                            <div class="event_box_caption">    
                    <h1><?php echo e($postagen->nome); ?></h1>
                    <p><span class="glyphicon glyphicon-map-marker"></span> New Hotel, Bangkok, Thailand &nbsp;&nbsp; <span class="glyphicon glyphicon-time"></span> <?php echo e($postagen->created_at); ?></p>
                  <p><?php echo e($postagen->descricao); ?></p>  
                    </div>
                        </div>
                    </div>      
                <?php endforeach; ?>
...
<?php echo $__env->make('layout.elegant', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>