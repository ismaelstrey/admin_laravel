...
<?php echo Form::open(['route'=>['admin.cadastro.banner.store']]); ?>

<?php echo $__env->make('admin.Cadastro.forms.banner', ['reset' => 'Cancelar', 'submit'=>'Cadastrar'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo Form::close(); ?>
